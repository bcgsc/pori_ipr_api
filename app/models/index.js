...
project.belongsToMany(POG, {as: 'pogs', through: {model: pogProject, unique: false}, foreignKey: 'project_id', otherKey: 'pog_id', onDelete: 'CASCADE'});
POG.belongsToMany(project, {as: 'projects', through: {model: pogProject, unique: false}, foreignKey: 'pog_id', otherKey: 'project_id', onDelete: 'CASCADE'});

project.belongsToMany(user, {as: 'users', through: {model: userProject, unique: false}, foreignKey: 'project_id', otherKey: 'user_id', onDelete: 'CASCADE'});
user.belongsToMany(project, {as: 'projects', through: {model: userProject, unique: false}, foreignKey: 'user_id', otherKey: 'project_id', onDelete: 'CASCADE'});
...
analysisReports.hasMany(analysisReportsUsers, {as: 'users', foreignKey: 'report_id', onDelete: 'CASCADE', constraints: true});
analysisReports.hasMany(analysisReportsUsers, {as: 'ReportUserFilter', foreignKey: 'report_id', onDelete: 'CASCADE', constraints: true});
analysisReportsUsers.belongsTo(analysisReports, {as: 'report', foreignKey: 'report_id', onDelete: 'CASCADE', constraints: true});
analysisReportsUsers.belongsTo(user, {as: 'addedBy', foreignKey: 'addedBy_id', onDelete: 'SET NULL', constraints: true});
analysisReportsUsers.belongsTo(user, {as: 'user', foreignKey: 'user_id', onDelete: 'CASCADE', constraints: true});

user.belongsToMany(analysisReports, {as: 'reports', through: {model: analysisReportsUsers, unique: false }, foreignKey: 'user_id', otherKey: 'report_id', onDelete: 'CASCADE'});
...
analysisReports.hasOne(patientInformation, {as: 'patientInformation', foreignKey: 'pog_report_id', onDelete: 'CASCADE', constraints: true});
patientInformation.belongsTo(analysisReports, {as: 'report', foreignKey: 'pog_report_id', onDelete: 'CASCADE', constraints: true});
...
summary.genomicEventsTherapeutic.belongsTo(analysisReports, {as: 'report', foreignKey: 'pog_report_id', targetKey: 'id', onDelete: 'CASCADE', constraints: true});
summary.mutationSummary.belongsTo(analysisReports, {as: 'report', foreignKey: 'pog_report_id', targetKey: 'id', onDelete: 'CASCADE', constraints: true});
summary.variantCounts.belongsTo(analysisReports, {as: 'report', foreignKey: 'pog_report_id', targetKey: 'id', onDelete: 'CASCADE', constraints: true});
summary.genomicAlterationsIdentified.belongsTo(analysisReports, {as: 'report', foreignKey: 'pog_report_id', targetKey: 'id', onDelete: 'CASCADE', constraints: true});
summary.analystComments.belongsTo(analysisReports, {as: 'report', foreignKey: 'pog_report_id', targetKey: 'id', onDelete: 'CASCADE', constraints: true});
summary.pathwayAnalysis.belongsTo(analysisReports, {as: 'report', foreignKey: 'pog_report_id', targetKey: 'id', onDelete: 'CASCADE', constraints: true});
summary.probeTarget.belongsTo(analysisReports, {as: 'report', foreignKey: 'pog_report_id', targetKey: 'id', onDelete: 'CASCADE', constraints: true});
summary.microbial.belongsTo(analysisReports, {as: 'report', foreignKey: 'pog_report_id', targetKey: 'id', onDelete: 'CASCADE', constraints: true});
summary.tumourAnalysis.belongsTo(analysisReports, {as: 'report', foreignKey: 'pog_report_id', targetKey: 'id', onDelete: 'CASCADE', constraints: true});

summary.mutationSummaryv2.belongsTo(analysisReports, {as: 'report', foreignKey: 'pog_report_id', targetKey: 'id', onDelete: 'CASCADE', constraints: true});
...
alterations.belongsTo(analysisReports, {as: 'report', foreignKey: 'pog_report_id', targetKey: 'id', onDelete: 'CASCADE', constraints: true});
targetedGenes.belongsTo(analysisReports, {as: 'report', foreignKey: 'pog_report_id', targetKey: 'id', onDelete: 'CASCADE', constraints: true});
...
somaticMutations.smallMutations.belongsTo(analysisReports, {as: 'report', foreignKey: 'pog_report_id', targetKey: 'id', onDelete: 'CASCADE', constraints: true});
somaticMutations.mutationSignature.belongsTo(analysisReports, {as: 'report', foreignKey: 'pog_report_id', targetKey: 'id', onDelete: 'CASCADE', constraints: true});

// Copy Number Analysis
const copyNumberAnalyses = {};
copyNumberAnalyses.cnv = sequelize.import('./reports/genomic/copyNumberAnalysis/cnv');
copyNumberAnalyses.cnv.belongsTo(analysisReports, {as: 'report', foreignKey: 'pog_report_id', targetKey: 'id', onDelete: 'CASCADE', constraints: true});
...
structuralVariation.sv.belongsTo(analysisReports, {as: 'report', foreignKey: 'pog_report_id', targetKey: 'id', onDelete: 'CASCADE', constraints: true});
...
expressionAnalysis.outlier.belongsTo(analysisReports, {as: 'report', foreignKey: 'pog_report_id', targetKey: 'id', onDelete: 'CASCADE', constraints: true});
expressionAnalysis.drugTarget.belongsTo(analysisReports, {as: 'report', foreignKey: 'pog_report_id', targetKey: 'id', onDelete: 'CASCADE', constraints: true});
...
presentation.discussion.belongsTo(analysisReports, {as: 'report', foreignKey: 'pog_report_id', targetKey: 'id', onDelete: 'CASCADE', constraints: true});
presentation.slides.belongsTo(analysisReports, {as: 'report', foreignKey: 'pog_report_id', targetKey: 'id', onDelete: 'CASCADE', constraints: true});
...
probeTestInformation.belongsTo(analysisReports, {as: 'report', foreignKey: 'pog_report_id', targetKey: 'id', onDelete: 'CASCADE', constraints: true});
...
probeSignature.belongsTo(analysisReports, {as: 'report', foreignKey: 'pog_report_id', targetKey: 'id', onDelete: 'CASCADE', constraints: true});
...
if (nconf.get('database:migrate') && nconf.get('database:hardMigrate')) {
  ...
  sequelize.sync(
    ...
    async (res) => {
      ...
      try {
        // Insert Admin User
        await user.create({username: 'admin', password: bcrypt.hashSync('AdminMaster', 10), firstName: 'Admin', lastName: 'User', email: 'iprAdmin@bcgsc.ca', access: 'superUser'});
