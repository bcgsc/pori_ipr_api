...
const SPECIAL_CASES = [
  ...
  },
  {
    ...
    POST: [{name: 'admin'}, {name: 'manager'}, {name: 'create report access'}, {name: 'germline access'}, {name: 'Germline Access'}],
    DELETE: [{name: 'admin'}, {name: 'manager'}, {name: 'create report access'}, {name: 'germline access'}, {name: 'Germline Access'}],
  },
  {
