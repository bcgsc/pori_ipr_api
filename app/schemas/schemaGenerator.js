 ...
 * @param {boolean} options.isJsonSchema - Whether to generate a json schema or an openApi schema
...
const schemaGenerator = (model, {
  baseUri = '/', isJsonSchema = true, properties = {}, include = [], exclude = REPORT_EXCLUDE,
  ...
  const type = (isJsonSchema) ? new JsonSchema7Strategy() : new OpenApi3Strategy();
