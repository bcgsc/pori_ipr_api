...
// const schema = schemaManager.generate(db.models.genomicAlterationsIdentified, new JsonSchema7Strategy(), {
...
module.exports = schemaGenerator(db.models.genomicAlterationsIdentified);
