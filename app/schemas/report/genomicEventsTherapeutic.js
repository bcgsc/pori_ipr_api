...
// const schema = schemaManager.generate(db.models.genomicEventsTherapeutic, new JsonSchema7Strategy(), {
...
module.exports = schemaGenerator(db.models.genomicEventsTherapeutic);
