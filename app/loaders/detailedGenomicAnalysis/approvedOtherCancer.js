...
module.exports = (POG, logger) => {
  ...
  let output = fs.createReadStream(nconf.get('paths:data:POGdata') + '/' + POG.POGID + '/JReport/Genomic/JReport_CSV_ODF/approved_other_cancer_type_detailed.csv', {'delimiter': ','})
