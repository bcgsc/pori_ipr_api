 ...
 *
 */
const recordCreate = async (entryIdent, modelName, userId, reportId, displayName) => {
 ...
 *
 */
const recordUpdate = async (entryIdent, modelName, fieldName, previousValue, newValue, userId, reportId, displayName, comment) => {
 ...
 *
 */
const recordDelete = async (entryIdent, modelName, deletedContent, userId, reportId, displayName, comment) => {
 ...
 *
 */
const revert = async (changeHistoryId, userId, comment) => {
  ...
  try {
    ...
    switch (changeHistoryEvent.type) {
      case 'update': {
        ...
        const recordUpdateSuccess = await recordUpdate(
      ...
      case 'delete': {
        ...
        if (!recordExists && isMostRecentDelete) {
          ...
          const recordCreateSuccess = await recordCreate(
