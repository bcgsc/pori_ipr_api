...
describe('Test alteration endpoints', () => {
  ...
  it('Should successfully create a new targeted gene alteration and record change history', async () => {
    ...
    const res = await api.post(`/api/1.0/POG/${patient.POGID}/report/${testReport.ident}/probe/alterations`)
  ...
  it('Should successfully update a targeted gene alteration and record change history', async () => {
    ...
    const res = await api.put(`/api/1.0/POG/${patient.POGID}/report/${testReport.ident}/probe/alterations/${alteration.ident}`)
      .set('Authorization', 'Basic bm1hcnRpbjooe31vKzBjTmY=')
      .send(updateAlt);
  ...
  it('Should successfully delete a targeted gene alteration and record change history', async () => {
    ...
    const res = await api.delete(`/api/1.0/POG/${patient.POGID}/report/${testReport.ident}/probe/alterations/${alteration.ident}`)
      .set('Authorization', 'Basic bm1hcnRpbjooe31vKzBjTmY=')
      .send(deleteAlt);
